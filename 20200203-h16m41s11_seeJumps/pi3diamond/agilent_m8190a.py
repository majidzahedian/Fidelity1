...
#         return '{}/{}_current_{}_settings'.format(self.__SETTINGS_FOLDER__, datetime.datetime.now().strftime('%Y%m%d-h%Hm%Ms%S'), self.name)
#
#     @property
...
#         return'{}/{}'.format(self.__SETTINGS_FOLDER__, file_list[-1])
#
